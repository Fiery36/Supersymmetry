...
BR.recipeBuilder()
    ...
    .fluidOutputs(fluid('vanillylmandelic_acid_mixture') * 1000)
    .duration(160)
    .EUt(120)
    .buildAndRegister()
...
BR.recipeBuilder()
    ...
    .fluidInputs(fluid('vanillylmandelic_acid_mixture') * 1000)
    .fluidOutputs(fluid('water') * 1000)
    .fluidOutputs(fluid('vanilglycolic_acid_mixture') * 1000)
    .duration(160)
    .EUt(120)
    .buildAndRegister()
...
LCR.recipeBuilder()
    ...
    .fluidInputs(fluid('vanilglycolic_acid_mixture') * 1000)
