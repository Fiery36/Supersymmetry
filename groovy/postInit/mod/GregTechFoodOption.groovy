...
BR.recipeBuilder()
    ...
    .fluidInputs(fluid('sodium_vanillylmandelate_solution') * 1000)
    .fluidOutputs(fluid('water') * 1000)
    .fluidOutputs(fluid('sodium_vanilglycolate_solution') * 1000)
    .duration(160)
    .EUt(120)
    .buildAndRegister()
...
LCR.recipeBuilder()
    ...
    .fluidInputs(fluid('sodium_vanilglycolate_solution') * 1000)
