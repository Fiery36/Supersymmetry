...
for(color in lamp_colors) {
	for(int i = 0; i < 8; i++) {
		...
		ASSEMBLER.recipeBuilder()
			.fluidInputs(fluid('dye_'+color) * 144)
			.inputs(metaitem('plateGlass') * 6)
			.inputs(ore('gtLight'))
			.inputs(ore('frameGtSteel'))
			.outputs(item('gregtech:'+color+'_lamp') * 4)
			.circuitMeta(1)
			.duration(40)
			.EUt(7)
			.buildAndRegister()
		...
		ASSEMBLER.recipeBuilder()
			.fluidInputs(fluid('dye_'+color) * 288)
			.inputs(metaitem('plateGlass') * 6)
			.inputs(ore('gtLight'))
			.inputs(ore('frameGtAluminium'))
			.outputs(item('gregtech:'+color+'_lamp') * 8)
			.circuitMeta(1)
			.duration(40)
			.EUt(7)
			.buildAndRegister()
		...
		ASSEMBLER.recipeBuilder()
			.fluidInputs(fluid('dye_'+color) * 432)
			.inputs(metaitem('plateGlass') * 6)
			.inputs(ore('gtLight'))
			.inputs(ore('frameGtStainlessSteel'))
			.outputs(item('gregtech:'+color+'_lamp') * 16)
			.circuitMeta(1)
			.duration(40)
			.EUt(7)
			.buildAndRegister()
		...
		ASSEMBLER.recipeBuilder()
			.fluidInputs(fluid('dye_'+color) * 576)
			.inputs(metaitem('plateGlass') * 6) 
			.inputs(ore('gtLight'))
			.inputs(ore('frameGtTitanium'))
			.outputs(item('gregtech:'+color+'_lamp') * 32)
			.circuitMeta(1)
			.duration(40)
			.EUt(7)
			.buildAndRegister()
...
for(int i = 0; i < 8; i++) {
	...
	mods.gregtech.assembler.removeByInput(7, [metaitem('plateGlass') * 6, item('minecraft:glowstone_dust'), metaitem('circuit.integrated').withNbt(['Configuration': i+9])], [fluid('dye_light_gray') * 144 * 144])
		...
		ASSEMBLER.recipeBuilder()
			...
			.inputs(ore('gtLight'))
			.inputs(ore('frameGtSteel'))
			.outputs(item('gregtech:silver_lamp') * 4)
			.circuitMeta(1)
			.duration(40)
			.EUt(7)
			.buildAndRegister()	
		...
		ASSEMBLER.recipeBuilder()
			...
			.inputs(ore('gtLight'))
			.inputs(ore('frameGtAluminium'))
			.outputs(item('gregtech:silver_lamp') * 8)
			.circuitMeta(1)
			.duration(40)
			.EUt(7)
			.buildAndRegister()
		...
		ASSEMBLER.recipeBuilder()
			.fluidInputs(fluid('dye_light_gray') * 432)
			.inputs(metaitem('plateGlass') * 6)
			.inputs(ore('gtLight'))
			.inputs(ore('frameGtStainlessSteel'))
			.outputs(item('gregtech:silver_lamp') * 16)
			.circuitMeta(1)
			.duration(40)
			.EUt(7)
			.buildAndRegister()
		...
		ASSEMBLER.recipeBuilder()
			.fluidInputs(fluid('dye_light_gray') * 576)
			.inputs(metaitem('plateGlass') * 6)
			.inputs(ore('gtLight'))
			.inputs(ore('frameGtTitanium'))
			.outputs(item('gregtech:silver_lamp') * 32)
			.circuitMeta(1)
			.duration(40)
			.EUt(7)
			.buildAndRegister()
