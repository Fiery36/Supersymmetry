...
MIXER.recipeBuilder()
        .circuitMeta(1)
        .fluidInputs(fluid('di_two_ethylhexyl_phosphoric_acid_solution') * 100)
...
FBR.recipeBuilder()
        ...
        .fluidInputs(fluid('phosphorous_acid') * 50)
        .fluidInputs(fluid('two_ethylhexanol') * 50)
        .fluidOutputs(fluid('ethylhexyl_phosphonic_acid_solution') * 100)
        .duration(5)
        .EUt(40)
        .buildAndRegister()
...
DISTILLERY.recipeBuilder()
        .circuitMeta(1)
        .fluidInputs(fluid('ethylhexyl_phosphonic_acid_solution') * 100)
        .fluidOutputs(fluid('ethylhexyl_phosphonic_acid_mono_ethylhexyl_ester') * 50)
        .duration(10)
        .EUt(30)
        .buildAndRegister()
...
DISTILLATION_TOWER.recipeBuilder()
        .fluidInputs(fluid('ethylhexyl_phosphonic_acid_solution') * 2000)
...
MIXER.recipeBuilder()
        .fluidInputs(fluid('kerosene') * 100)
        .fluidInputs(fluid('ethylhexyl_phosphonic_acid_mono_ethylhexyl_ester') * 900)
        .fluidOutputs(fluid('rare_earth_separation_mixture') * 1000)
        .duration(120)
        .EUt(120)
        .buildAndRegister()