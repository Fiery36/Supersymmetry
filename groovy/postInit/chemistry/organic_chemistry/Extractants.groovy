...
//LIQUID-LIQUID EXTRACTANTS
    ...
    CSTR.recipeBuilder()
        ...
        .fluidInputs(fluid('two_ethylhexyl_alcohol') * 50)
        .fluidOutputs(fluid('water') * 50)
    ...
    CSTR.recipeBuilder()
        .fluidInputs(fluid('trimethyl_phosphate') * 50)
    ...
    MIXER.recipeBuilder()
        .inputs(ore('dustSmallSodiumHydroxide') * 3)
        .fluidInputs(fluid('di_two_ethylhexylphosphinic_acid') * 1000)
        .fluidInputs(fluid('two_ethylhexyl_phosphonic_acid_mono_two_ethylhexyl_ester') * 1000)
        .fluidInputs(fluid('two_ethylhexanol') * 1000)
    ...
    BR.recipeBuilder()
        ...
        .fluidOutputs(fluid('trioctylmethylammonium_chloride') * 1000)
        .duration(100)
        .EUt(120)
        .buildAndRegister()

    MIXER.recipeBuilder()
        .fluidInputs(fluid('trioctylmethylammonium_chloride') * 500)
