...
BR.recipeBuilder()
        ...
        .fluidOutputs(fluid('2_ethylhexyl_tosylate') * 1000)
        .fluidOutputs(fluid('ammonium_chloride_solution') * 1000)
        .duration(80)
        .EUt(30)
        .buildAndRegister() // For this reaction, phosphorus oxychloride or ammonium salts are used, as water is a byproduct, I made it a solution of the salt

BR.recipeBuilder()
        .inputs(ore('dustPotassiumIodide') * 2)
        .fluidInputs(fluid('2_ethylhexyl_tosylate') * 1000)
        .fluidOutputs(fluid('potassium_tosylate') * 1000)
        .fluidOutputs(fluid('2_ethylhexyl_iodide') * 1000)
        .duration(80)
        .EUt(120)
        .buildAndRegister()
...
BR.recipeBuilder()
        ...
        .fluidInputs(fluid('phosphorus_trichloride') * 1000)
        .outputs(metaitem('dustSalt') * 6)
        .fluidOutputs(fluid('trimethyl_phosphate') * 1000)
        .duration(120)
        .EUt(120)
        .buildAndRegister()

ROASTER.recipeBuilder()
        .fluidInputs(fluid('trimethyl_phosphate') * 1000)
        .fluidInputs(fluid('two_ethylhexanol') * 3000)
        .fluidOutputs(fluid('methanol') * 3000)
        .fluidOutputs(fluid('tri_2_ethylhexyl_phosphite') * 1000)
        .duration(100)
        .EUt(120)
        .buildAndRegister()

CSTR.recipeBuilder()
        .notConsumable(fluid('2_ethylhexyl_iodide') * 1000)
        .fluidInputs(fluid('tri_2_ethylhexyl_phosphite') * 25)
        .fluidOutputs(fluid('ethylhexyl_phosphonic_acid_di_2_ethylhexyl_ester') * 25)
        .duration(10)
        .EUt(30)
        .buildAndRegister()

BR.recipeBuilder()
        .notConsumable(fluid('acetic_acid') * 500)
        .fluidInputs(fluid('water') * 1000)
        .fluidInputs(fluid('ethylhexyl_phosphonic_acid_di_2_ethylhexyl_ester') * 1000)
        .fluidOutputs(fluid('two_ethylhexanol') * 2000)
        .fluidOutputs(fluid('ethylhexyl_phosphonic_acid_mono_ethylhexyl_ester') * 1000)
        .duration(100)
        .EUt(120)
        .buildAndRegister()