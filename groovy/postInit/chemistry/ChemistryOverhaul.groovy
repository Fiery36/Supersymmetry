...
MIXER.recipeBuilder()
    ...
    .fluidInputs(fluid('gtfo_perchloric_acid') * 10)
    .fluidOutputs(fluid('benzenediol_catalysis_mixture') * 110)
    .duration(50)
    .EUt(30)
    .buildAndRegister()
...
DT.recipeBuilder()
    .fluidInputs(fluid('diluted_benzenediol_catalysis_mixture') * 160)
    .fluidOutputs(fluid('benzenediol_catalysis_mixture') * 110)
    .fluidOutputs(fluid('water') * 50)
    .duration(50)
    .EUt(30)
