...
CENTRIFUGE.recipeBuilder()
        ...
        .chancedOutput(metaitem('dustPraseodymiumHydroxide') * 18, 7580, 0)
...
CENTRIFUGE.recipeBuilder()
        ...
        .chancedOutput(metaitem('dustPraseodymiumHydroxide') * 9, 5000, 0)
...
CRYSTALLIZER.recipeBuilder()
        .fluidInputs(fluid('mona_hree_waste') * 1000)
        .outputs(metaitem('dustSodiumChromate') * 14)
        .outputs(metaitem('dustSmallSodiumDodecylSulfate') * 13)
        .chancedOutput(metaitem('dustSmallSodiumDodecylSulfate'), 5000, 0)
        //.chancedOutput(metaitem('dustSalt') * 6, 8766, 0) Uncomment when crystallizer has 3 output slots
        .fluidOutputs(fluid('wastewater') * 1000)
        .duration(40)
        .EUt(30)
        .buildAndRegister()
