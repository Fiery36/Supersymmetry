...
CENTRIFUGE.recipeBuilder()
    ...
    .fluidInputs(fluid('aliquat_336_extraction_mixture') * 670)
    .fluidOutputs(fluid('xeno_lree_free_concentrate') * 3000)
    .fluidOutputs(fluid('xeno_lree_extract') * 670)
    .duration(80)
    .EUt(120)
    .buildAndRegister()
...
CENTRIFUGE.recipeBuilder()
    ...
    .fluidInputs(fluid('xeno_lree_extract') * 670)
    .fluidOutputs(fluid('xeno_lree_concentrate') * 67)
    .fluidOutputs(fluid('aliquat_336_extraction_mixture') * 670)
    .duration(80)
    .EUt(120)
    .buildAndRegister()
...
CENTRIFUGE.recipeBuilder()
    ...
    .fluidInputs(fluid('P507_P229_extraction_mixture') * 22175)
...
CENTRIFUGE.recipeBuilder()
    ...
    .fluidInputs(fluid('aliquat_336_extraction_mixture') * 460)
    .fluidOutputs(fluid('wastewater') * 3000)
    .fluidOutputs(fluid('xeno_mree_extract') * 460)
    .duration(80)
    .EUt(120)
    .buildAndRegister()
...
CENTRIFUGE.recipeBuilder()
    ...
    .fluidInputs(fluid('xeno_mree_extract') * 4600)
    .fluidOutputs(fluid('xeno_enriched_mree_concentrate') * 1000)
    .fluidOutputs(fluid('aliquat_336_extraction_mixture') * 4600)
    .duration(80)
    .EUt(120)
    .buildAndRegister()
...
// LREE separation
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidInputs(fluid('aliquat_336_extraction_mixture') * 1000)
        .fluidOutputs(fluid('xeno_didymium_conentrate') * 1340)
        .fluidOutputs(fluid('lanthanium_extract') * 1000)
        .duration(80)
        .EUt(120)
        .buildAndRegister()
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidInputs(fluid('aliquat_336_extraction_mixture') * 1400)
        .fluidOutputs(fluid('xeno_nd_concentrate') * 1340)
        .fluidOutputs(fluid('praseodymium_extract') * 1400)
        .duration(80)
        .EUt(120)
        .buildAndRegister()
...
// MREE separation
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidInputs(fluid('P507_extraction_mixture') * 10000)
...
// HREE separation
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidInputs(fluid('aliquat_336_extraction_mixture') * 1720)
        .fluidOutputs(fluid('xeno_yttrium_concentrate') * 1000)
        .fluidOutputs(fluid('xeno_terbium_group_extract') * 1720)
        .duration(80)
        .EUt(120)
        .buildAndRegister()
    ...
    BR.recipeBuilder()
        .inputs(ore('dustSodiumHydroxide') * 6)
        .fluidInputs(fluid('xeno_yttrium_concentrate') * 1000)
    ...
    CENTRIFUGE.recipeBuilder()
        .fluidInputs(fluid('xeno_terbium_group_extract') * 1720)
        .fluidInputs(fluid('distilled_water') * 172)
        .fluidOutputs(fluid('aliquat_336_extraction_mixture') * 1720)
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidInputs(fluid('P507_P229_extraction_mixture') * 4300)
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidOutputs(fluid('xeno_terbium_free_extract') * 4300)
        .fluidOutputs(fluid('xeno_terbium_concentrate') * 138)
        .duration(80)
        .EUt(120)
        .buildAndRegister()

    BR.recipeBuilder()
        .fluidInputs(fluid('xeno_terbium_concentrate') * 6900)
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidInputs(fluid('xeno_terbium_free_extract') * 4300)
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidOutputs(fluid('spent_P507_P229_extraction_mixture') * 4300)
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidOutputs(fluid('spent_P507_P229_extraction_mixture') * 22175)
