...
ROASTER.recipeBuilder()
    ...
    .outputs(metaitem('dustMonaOxReHydroxides'))
    .duration(80)
    .EUt(120)
    .buildAndRegister()

BR.recipeBuilder()
    .inputs(ore('dustMonaOxReHydroxides'))
...
// LREE separation
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidInputs(fluid('aliquat_336_extraction_mixture') * 410)
        .fluidOutputs(fluid('mona_nd_concentrate') * 910)
        .fluidOutputs(fluid('praseodymium_extract') * 410)
        .duration(80)
        .EUt(120)
        .buildAndRegister()
...
// HREE separation
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidInputs(fluid('P507_P229_extraction_mixture') * 8375)
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidInputs(fluid('P507_P229_extraction_mixture') * 3725)
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidOutputs(fluid('mona_terbium_free_extract') * 3725)
    ...
    BR.recipeBuilder()
        .fluidInputs(fluid('mona_terbium_concentrate') * 6625)
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidInputs(fluid('mona_terbium_free_extract') * 3725)
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidOutputs(fluid('spent_P507_P229_extraction_mixture') * 8375)
