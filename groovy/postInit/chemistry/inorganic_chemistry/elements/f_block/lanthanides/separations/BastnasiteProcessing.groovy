...
// LREE separation
    ...
    CRYSTALLIZER.recipeBuilder()
        .inputs(ore('dustAmmoniumCarbonate') * 19)
...
// MREE separation
    ...
    BR.recipeBuilder()
        .fluidInputs(fluid('reduced_bast_mree_concentrate') * 4350)
...
// HREE separation
    ...
    // Lu: 0
    // Y: 0.15
    // Per 0.5*1225L of bastnasite HREE concentrate
    ...
    BR.recipeBuilder()
        ...
        .inputs(ore('dustSodiumHydroxide') * 9)
        .chancedOutput(metaitem('dustTerbiumHydroxide') * 7, 1500, 0)
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidOutputs(fluid('bast_dysprosium_concentrate') * 180)
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidOutputs(fluid('holmium_chloride_solution') * 12)
        .duration(80)
        .EUt(120)
        .buildAndRegister()
    ...
    ION_EXCHANGE.recipeBuilder()
        ...
        .fluidInputs(fluid('bast_tm_yb_concentrate') * 1000)
        .outputs(metaitem('beads.loaded_ytterbium_cation_exchange'))
        .fluidOutputs(fluid('bast_tm_concentrate') * 1000)
        .duration(400)
        .EUt(16)
        .buildAndRegister()
    ...
    ION_EXCHANGE.recipeBuilder()
        .fluidInputs(fluid('pentetic_acid_solution'))
        .inputs(metaitem('beads.loaded_ytterbium_cation_exchange'))
        .fluidOutputs(fluid('ytterbium_concentrate'))
