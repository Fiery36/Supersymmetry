...
SINGLE_COLUMN_CRYOGENIC_DISTILLATION_PLANT.recipeBuilder()
    ...
    .fluidOutputs(fluid('liquid_argon_product') * 250) //the increase in LAR product is not enough to justify using this recipe - 50LAR products only return you 266.67 AR gas
