...
PSA.recipeBuilder()
    .notConsumable(metaitem('zeolite_membrane'))
    .fluidInputs(fluid('combusted_krypton_xenon_concentrate') * 48)
    .fluidOutputs(fluid('filtered_krypton_xenon_concentrate') * 48)
    .duration(100)
    .EUt(Globals.voltAmps[3])
    .buildAndRegister()

SINGLE_COLUMN_CRYOGENIC_DISTILLATION_PLANT.recipeBuilder()
    .fluidInputs(fluid('filtered_krypton_xenon_concentrate') * 22224)
    .chancedOutput(fluid('krypton') * 110, 1111, 0)
