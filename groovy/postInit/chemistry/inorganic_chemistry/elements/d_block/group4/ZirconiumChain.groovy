...
TUBE_FURNACE.recipeBuilder()
    .inputs(ore('dustZirconiumDioxide') * 64)
    .inputs(ore('dustZirconiumDioxide') * 5)
    .inputs(ore('dustYttriumOxide') * 10)
    .outputs(metaitem('dustYttriaStabilizedZirconia') * 64) // Cubic (8% Y2O3)
    .outputs(metaitem('dustYttriaStabilizedZirconia') * 15)
    .duration(200)
    .EUt(Globals.voltAmps[2])
    .buildAndRegister()