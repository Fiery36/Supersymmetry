...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        ...
        CeriumIVNitrate = new Material.Builder(8643, SuSyUtility.susyId('cerium_iv_nitrate'))
                .dust()
        ...
        EthylHexylPhosphonicAcidMonoEthylHexylEster = new Material.Builder(8644, SuSyUtility.susyId('ethylhexyl_phosphonic_acid_mono_ethylhexyl_ester_solution'))
                .liquid()
                .components(Carbon * 16, Hydrogen * 35, Oxygen * 3, Phosphorus)
                .colorAverage()
                .build()

        AmmoniumCarbonate = new Material.Builder(8645, SuSyUtility.susyId('ammonium_carbonate'))
                .dust()
        ...
        PotassiumChlorate = new Material.Builder(8646, SuSyUtility.susyId('potassium_chlorate'))
                .dust()
                .components(Potassium, Chlorine, Oxygen * 3)
                .colorAverage()
                .build()

        SodiumAmalgam = new Material.Builder(8647, SuSyUtility.susyId('sodium_amalgam'))
                .liquid(new FluidBuilder().temperature(363))
                .components(Sodium * 3, Mercury)
                .color(0x5f527d)
                .build()

        LanthanumCarbonate = new Material.Builder(8648, SuSyUtility.susyId('lanthanum_carbonate'))
                .dust()
        ...
        LanthanumOxide = new Material.Builder(8649, SuSyUtility.susyId('lanthanum_oxide'))
                .dust()
                .components(Lanthanum * 2, Oxygen * 3)
                .color(0xe5e593)
                .build()

        PraseodymiumOxide = new Material.Builder(8650, SuSyUtility.susyId('praseodymium_oxide'))
                .dust()
                .components(Praseodymium * 2, Oxygen * 3)
                .color(0xbff583)
                .build()

        EuropiumIISulfate = new Material.Builder(8651, SuSyUtility.susyId('europium_ii_sulfate'))
                .dust()
                .components(Europium , Oxygen * 4, Sulfur)
                .color(0xbff583)
                .build()

        EuropiumOxide = new Material.Builder(8652, SuSyUtility.susyId('europium_oxide'))
                .dust()
                .components(Europium, Oxygen)
                .color(0xbff583)
                .build()

        SamariumAmalgam = new Material.Builder(8653, SuSyUtility.susyId('samarium_amalgam'))
                .liquid(new FluidBuilder().temperature(363))
                .components(Samarium, Mercury, Sodium * 3)
                .color(0xbff583)
                .build()

        SamariumChloride = new Material.Builder(8654, SuSyUtility.susyId('samarium_chloride'))
                .dust()
                .components(Samarium, Chlorine * 3)
                .color(0xbff583)
                .build()

        SamariumOxide = new Material.Builder(8655, SuSyUtility.susyId('samarium_oxide'))
                .dust()
                .components(Samarium * 2, Oxygen * 3)
                .color(0xbff583)
                .build()

        GadoliniumHydroxide = new Material.Builder(8656, SuSyUtility.susyId('gadolinium_hydroxide'))
                .dust()
        ...
        GadoliniumOxide = new Material.Builder(8657, SuSyUtility.susyId('gadolinium_oxide'))
                .dust()
                .components(Gadolinium * 2, Oxygen * 3)
                .color(0xbff583)
                .build()

        TerbiumCarbonate = new Material.Builder(8658, SuSyUtility.susyId('terbium_carbonate'))
                .dust()
        ...
        TerbiumOxide = new Material.Builder(8659, SuSyUtility.susyId('terbium_oxide'))
                .dust()
                .components(Terbium * 2, Oxygen * 3)
                .color(0xbff583)
                .build()

        DysprosiumFluoride = new Material.Builder(8660, SuSyUtility.susyId('dysprosium_fluoride'))
                .dust()
