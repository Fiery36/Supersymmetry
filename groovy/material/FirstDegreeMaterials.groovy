...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        ...
        AmmoniumCarbonate = new Material.Builder(8650, SuSyUtility.susyId('ammonium_carbonate'))
                .dust()
        ...
        LanthanumCarbonate = new Material.Builder(8653, SuSyUtility.susyId('lanthanum_carbonate'))
                .dust()
        ...
        EuropiumIISulfate = new Material.Builder(8656, SuSyUtility.susyId('europium_ii_sulfate'))
                .dust()
                .components(Europium , Oxygen * 4, Sulfur)
                .color(0x56abb5)
                .build()

        EuropiumOxide = new Material.Builder(8657, SuSyUtility.susyId('europium_oxide'))
                .dust()
        ...
        SamariumChloride = new Material.Builder(8659, SuSyUtility.susyId('samarium_chloride'))
                .dust()
                .components(Samarium, Chlorine * 3)
                .color(0x9c8d2d)
                .build()

        SamariumFluoride = new Material.Builder(8660, SuSyUtility.susyId('samarium_fluoride'))
                .dust()
                .components(Samarium, Fluorine * 3)
                .color(0xebdcb2)
                .build()

        GadoliniumHydroxide = new Material.Builder(8661, SuSyUtility.susyId('gadolinium_hydroxide'))
                .dust()
        ...
        GadoliniumOxide = new Material.Builder(8662, SuSyUtility.susyId('gadolinium_oxide'))
                .dust()
                .components(Gadolinium * 2, Oxygen * 3)
                .color(0xc49c81)
                .build()

        TerbiumCarbonate = new Material.Builder(8663, SuSyUtility.susyId('terbium_carbonate'))
                .dust()
        ...
        TerbiumOxide = new Material.Builder(8664, SuSyUtility.susyId('terbium_oxide'))
                .dust()
                .components(Terbium * 2, Oxygen * 3)
                .color(0x563118)
                .build()

        DysprosiumFluoride = new Material.Builder(8665, SuSyUtility.susyId('dysprosium_fluoride'))
                .dust()
                .components(Dysprosium, Fluorine * 3)
                .color(0x92c3b5)
                .build()

        YttriumChlorideSolution = new Material.Builder(8666, SuSyUtility.susyId('yttrium_chloride_solution'))
                .liquid()
        ...
        YttriumChloride = new Material.Builder(8667, SuSyUtility.susyId('yttrium_chloride'))
                .dust()
                .components(Yttrium, Chlorine * 3)
                .color(0xa581cc)
                .build()

        ErbiumDodecylSulfate = new Material.Builder(8668, SuSyUtility.susyId('erbium_dodecyl_sulfate'))
                .dust()
        ...
        ErbiumHydroxide = new Material.Builder(8669, SuSyUtility.susyId('erbium_hydroxide'))
                .dust()
        ...
        ErbiumOxide = new Material.Builder(8670, SuSyUtility.susyId('erbium_oxide'))
                .dust()
                .components(Erbium * 2, Oxygen * 3)
                .color(0xedc2fb)
                .build()

        HolmiumDodecylSulfate = new Material.Builder(8671, SuSyUtility.susyId('holmium_dodecyl_sulfate'))
                .dust()
        ...
        HolmiumHydroxide = new Material.Builder(8672, SuSyUtility.susyId('holmium_hydroxide'))
                .dust()
        ...
        HolmiumOxide = new Material.Builder(8673, SuSyUtility.susyId('holmium_oxide'))
                .dust()
                .components(Holmium * 2, Oxygen * 3)
                .color(0xdfe374)
                .build()

        YtterbiumAmalgam = new Material.Builder(8674, SuSyUtility.susyId('ytterbium_amalgam'))
                .liquid(new FluidBuilder().temperature(363))
        ...
        YtterbiumChloride = new Material.Builder(8675, SuSyUtility.susyId('ytterbium_chloride'))
                .dust()
                .components(Ytterbium, Chlorine * 3)
                .color(0x86a85e)
                .build()

        YtterbiumFluoride = new Material.Builder(8676, SuSyUtility.susyId('ytterbium_fluoride'))
                .dust()
                .components(Ytterbium, Fluorine * 3)
                .color(0xc1f08b)
                .build()

        ThuliumChlorideSolution = new Material.Builder(8677, SuSyUtility.susyId('thulium_chloride_solution'))
                .liquid()
        ...
        ThuliumChloride = new Material.Builder(8678, SuSyUtility.susyId('thulium_chloride'))
                .dust()
                .components(Thulium, Chlorine * 3)
                .color(0xcdd99c)
                .build()

        LutetiumChlorideSolution = new Material.Builder(8679, SuSyUtility.susyId('lutetium_chloride_solution'))
                .liquid()
        ...
        LutetiumChloride = new Material.Builder(8680, SuSyUtility.susyId('lutetium_chloride'))
                .dust()
        ...
        LanthanumChloride = new Material.Builder(8684, SuSyUtility.susyId('lanthanum_chloride'))
                .dust()
